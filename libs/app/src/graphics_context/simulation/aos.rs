...
// use base::{math::{DVec2}, sim::{solver::particle::verlet_particle::VerletParticle, storage::AosStorage}};
...
// impl<S: AosStorage<Item = MyVerletParticle>> SimulationRenderer<S> for AosSimulationRenderer<MyVerletParticle> {
